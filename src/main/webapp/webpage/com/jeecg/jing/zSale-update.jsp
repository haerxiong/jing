...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="yearTotal" name="yearTotal" value='${zSale.yearTotal}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入年化合计"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="total" name="total" value='${zSale.total}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入合计"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="performance" name="performance" value='${zSale.performance}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入业绩年化"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="comment" name="comment" value='${zSale.comment}' type="text" maxlength="256" class="form-control input-sm" placeholder="请输入备注"  ignore="ignore" />
			</div>
		</div>
	</div>
	</form>
