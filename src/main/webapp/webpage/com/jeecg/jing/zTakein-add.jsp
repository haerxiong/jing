			...
			<div class="row">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
							<input name="takeinTime" type="text" class="form-control input-sm laydate-date"  ignore="ignore"  />
						</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
							<input name="endTime" type="text" class="form-control input-sm laydate-date"  ignore="ignore"  />
						</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
